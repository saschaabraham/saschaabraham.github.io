...
module.exports = "<div class=\"container-fluid\">\n  <mat-grid-list cols=\"10\" rowHeight=\"100px\">\n    <mat-grid-tile [colspan]=8 [style.background]=\"lightgray\">\n      <div class=\"text-left\" *ngIf=\"loggedin; else elseBlock\">\n        <h2> Hallo {{ userName }} ! </h2>\n      </div>\n    </mat-grid-tile>\n    <mat-grid-tile [colspan]=2 [style.background]=\"lightgray\">\n      <div class=\"text-left\" *ngIf=\"!loggedin\">\n        <amazon-login [clientId]=\"myClientId\" (amazonAuthResponse)=\"onAmazonAuthResponse($event)\">\n        </amazon-login>\n      </div>\n    </mat-grid-tile>\n    <mat-grid-tile [colspan]=9 [rowspan]=1>\n\n      <form class=\"main-form\" [style.background]=\"lightblue\">\n        <mat-form-field class=\"main-full-width\">\n          <input  matInput type=\"text\" placeholder=\"Name zur Anrede im Skill:\" value=\"{{userName}}\">\n        </mat-form-field>\n      </form>\n\n    </mat-grid-tile>\n    <mat-grid-tile>5</mat-grid-tile>\n    <mat-grid-tile [colspan]=9 [rowspan]=1 [style.background]=\"lightgreen\">\n      <form class=\"main-form\">\n        <mat-form-field class=\"main-full-width\">\n          <input matInput type=\"number\" placeholder=\"Anzahl der Medikamente:\" value=\"{{medAnzahl}}\">\n        </mat-form-field>\n      </form>\n    </mat-grid-tile>\n    <mat-grid-tile [colspan]=4 [rowspan]=1 [style.background]=\"lightgreen\">\n      <form class=\"main-form\">\n        <mat-form-field class=\"main-full-width\">\n          <input matInput type=\"text\" placeholder=\"Name des ersten Medikaments:\" value=\"{{medNameOne}}\">\n        </mat-form-field>\n      </form>\n    </mat-grid-tile>\n    <mat-grid-tile>6</mat-grid-tile>\n    <mat-grid-tile [colspan]=4 [rowspan]=1 [style.background]=\"lightgreen\">\n      <form class=\"main-form\">\n        <mat-form-field class=\"main-full-width\">\n          <input matInput type=\"text\" placeholder=\"Name des zweiten Medikaments:\" value=\"{{medNameTwo}}\">\n        </mat-form-field>\n      </form>\n    </mat-grid-tile>\n    <mat-grid-tile>7</mat-grid-tile>\n  </mat-grid-list>\n</div>\n<ng-template #elseBlock>\n  <h2>Bitte melden Sie sich über den Amazon Login Button an.</h2>\n</ng-template>"
